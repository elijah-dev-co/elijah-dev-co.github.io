parcelRequire = function(e, r, t, n) {
    ...
    "clu1": [function(require, module, exports) {
        ...
        "./../font/Calibre-SemiBold.woff": [
            ["Calibre-SemiBold.21cc3335.woff", "Mg7X"], "Mg7X"
        ],
        "./../font/Calibre-SemiBold.ttf": [
            ["Calibre-SemiBold.2c27f793.ttf", "rJ82"], "rJ82"
        ],
    ...
    "Focm": [function(require, module, exports) {
        ...
        var o = document.querySelectorAll(".social-links--box a");
        o.forEach(function(e) {
            e.target = "_blank"
        });
        var t = document.querySelector(".cursor");
        window.onmousemove = function(e) {
            t.setAttribute("style", "top: ".concat(e.pageY, "px; left: ").concat(e.pageX, "px; z-index: 2;"))
        };
        var r = gsap.timeline({
            paused: !0,
            reversed: !0
        ...
        var a = document.querySelector(".nav-icon");
        a.onclick = function() {
            r.reversed() ? (this.classList.add("nav-anim"), r.play(), document.body.classList.add("noScroll")) : (this.classList.remove("nav-anim"), r.reverse(), document.body.classList.remove("noScroll"))
        };
        var n = document.querySelectorAll(".list__item a");
        n.forEach(function(e) {
            e.addEventListener("click", function() {
                document.body.classList.remove("noScroll"), r.reverse(), a.classList.remove("nav-anim")
            })
        });
    }, {
        "./sass/main.scss": "clu1"
